				...
				if (this.readyState == 4 && this.status == 200) {
					...
					if (this.responseText) {
						...
						data.forEach(function (item) {
							...
							CreateElement(itemId, itemLibrary, libraryId, itemName, fileName, modifiedDate, targetHubItemName, targetHubModifiedDate);
...
function CreateElement(itemId, libraryName, libraryId, itemName, fileName, modifiedDate, targetItemName, targetModifiedDate) {
